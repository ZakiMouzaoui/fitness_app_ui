...
class CalendarAgendaState extends State<CalendarAgenda>
  ...
  void initState() {
    ...
    training = widget.training ?? const SizedBox.shrink();
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: isSelected ? LinearGradient(colors: AppColors.primaryG) : null,
                        boxShadow: [
                          isSelected
                              ? BoxShadow(
        ...
        children: [
          Row(
              ...
              children: [
                GestureDetector(
                  onTap: (){
                    getDate(DateTime(_selectedDate!.year, _selectedDate!.month-1, _selectedDate!.day));
                  },
                  child: SizedBox(
                    width: 20.w,
                    child: Icon(
                ...
                SizedBox(width: 30.w,),
                GestureDetector(
                  onTap: ()=>getDate(DateTime(_selectedDate!.year, _selectedDate!.month+1, _selectedDate!.day)),
                  child: SizedBox(
                    width: 20.w,
                    child: Icon(
            ...
            children: [
              ...
              Expanded(
                child: FullCalendar(
                  ...
                  dateSelectedBg: AppColors.primaryColor1,
